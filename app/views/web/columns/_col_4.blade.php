<!-- BEGIN: Item col-4: bootstrap col-md-3 -->
<div class="col-xs-12 col-sm-6 col-md-3 {{$itemContents[0]['layout']['cls']}}">
...
<!-- END: Item col-4: bootstrap col-md-3 -->

<!-- BEGIN: Item col-4: bootstrap col-md-3 -->
<div class="col-xs-12 col-sm-6 col-md-3 {{$itemContents[1]['layout']['cls']}}">
...
<!-- BEGIN: Item col-4: bootstrap col-md-3 -->
<div class="col-xs-12 col-sm-6 col-md-3 {{$itemContents[2]['layout']['cls']}}">
    ...
    @elseif ($itemContents[2]['type'] == 'profile')
        @include('web.typePartial._profile', ['contents' => $itemContents[2]['contents'], 'itemId' => $itemContents[2]['itemId'], 'rwc' => $itemContents[2]['layout']['rwc']])
...
<!-- BEGIN: Item col-4: bootstrap col-md-3 -->
<div class="col-xs-12 col-sm-6 col-md-3 {{$itemContents[3]['layout']['cls']}}">
    @if ($itemContents[3]['layout']['t'])
        <div class="header-content">
            {{'<'.$itemContents[3]['layout']['tag'].'>'}}{{$itemContents[3]['layout']['t']}}{{'</'.$itemContents[3]['layout']['tag'].'>'}}
        </div>
    @endif
    @if ($itemContents[3]['type'] == 'slider')
        @include('web.typePartial._slider', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @elseif ($itemContents[3]['type'] == 'post')
        @include('web.typePartial._post', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @elseif ($itemContents[3]['type'] == 'news')
        @include('web.typePartial._news', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @elseif ($itemContents[3]['type'] == 'gallery')
        @include('web.typePartial._gallery', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId'], 'rwc' => $itemContents[3]['layout']['rwc']])
    @elseif ($itemContents[3]['type'] == 'profile')
        @include('web.typePartial._profile', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId'], 'rwc' => $itemContents[3]['layout']['rwc']])
    @elseif ($itemContents[3]['type'] == 'banner')
        @include('web.typePartial._banner', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @elseif ($itemContents[3]['type'] == 'cForm')
        @include('web.typePartial._cForm', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @else
        @include('web.typePartial._post', ['contents' => $itemContents[3]['contents'], 'itemId' => $itemContents[3]['itemId']])
    @endif
</div>
