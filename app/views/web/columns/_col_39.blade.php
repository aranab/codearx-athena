<!-- BEGIN: Item col-3: bootstrap col-md-3 -->
<div class="col-xs-12 col-sm-3 col-md-3 {{$itemContents[0]['layout']['cls']}}">
...
<!-- END: Item col-3: bootstrap col-md-3 -->

<!-- BEGIN: Item col-9: bootstrap col-md-9 -->
<div class="col-xs-12 col-sm-9 col-md-9 {{$itemContents[1]['layout']['cls']}}">
...
<!-- END: Item col-9: bootstrap col-md-9 -->
