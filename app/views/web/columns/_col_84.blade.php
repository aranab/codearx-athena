<!-- BEGIN: Item col-8: bootstrap col-md-8 -->
<div class="col-xs-12 col-sm-8 col-md-8 {{$itemContents[0]['layout']['cls']}}">
...
<!-- END: Item col-8: bootstrap col-md-8 -->

<!-- BEGIN: Item col-4: bootstrap col-md-4 -->
<div class="col-xs-12 col-sm-4 col-md-4 {{$itemContents[1]['layout']['cls']}}">
...
<!-- END: Item col-4: bootstrap col-md-4 -->
