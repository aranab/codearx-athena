                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;"
                                   id="company"
                                   data-type="text"
                                   data-original-title="Enter company name"
                                   data-pk="{{$userInfo->id}}">{{$userInfo->company}}</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <a href="javascript:;"
                                   id="designation"
                                   data-type="text"
                                   data-original-title="Enter designation"
                                   data-pk="{{$userInfo->id}}">{{$userInfo->designation}}</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
