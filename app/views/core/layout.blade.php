...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Web Controller Dashboard</title>
    ...
    <link href="{{asset('/assets/global/plugins/bootstrap-editable/bootstrap-editable/css/bootstrap-editable.css')}}"
          rel="stylesheet" type="text/css" />
    <!-- Summernote editor -->
    <link href="{{asset('assets/global/plugins/summernote/summernote.css')}}"
          rel="stylesheet" type="text/css" />
    <!-- Bootstrap Touch spin -->
    <link href="{{asset('assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.css')}}"
          rel="stylesheet" type="text/css" />
    ...
    @yield('styleFile')
    <link rel="shortcut icon" href="{{asset($configs[6]->value)}}"/>
</head>
<!-- END HEAD -->
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu page-header-fixed"
                ...
                <li class="sidebar-search-wrapper cus-sidebar-search-wrapper" style="background-color: #E4E4E4">
                    <!-- BEGIN RESPONSIVE QUICK SEARCH FORM -->
                    <a href="{{url('/core/')}}" class="pull-left">
                        <img src="{{asset($configs[5]->value)}}"
                ...
                <li class="nav-item sidebar-profile-wrapper">
                    <div class="sidebar2-profile-inner-wrapper">
                        <div class="sidebar2-portfolio">
                            ...
                            <p class="cus2-sidebar-portfolio-status">
                                <em>
                                    (Web Controller)
                                </em>
                            </p>
                ...
                @include('core.partials._sideBarPartial')
            ...
            <div class="page-header navbar">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="top-menu col-sm-6">
                        ...
                        @include('core.partials._userLoginPartial')
...
<div class="page-footer">
    <div class="page-footer-inner pull-right">
        <?php echo date('Y'); ?> &copy; Athena Venture. |
...
<script src="{{asset('/assets/global/plugins/bootstrap-editable/bootstrap-editable/js/bootstrap-editable.js')}}"
        type="text/javascript"></script>
<!-- Summernote editor -->
<script src="{{asset('assets/global/plugins/summernote/summernote.min.js')}}"
       type="text/javascript"></script>
<!-- Bootstrap Touch spin -->
<script src="{{asset('assets/global/plugins/fuelux/js/spinner.min.js')}}"
        type="text/javascript"></script>
