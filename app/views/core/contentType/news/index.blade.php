...
@section('title', 'NewsLetters-Section')
...
@section('bar')
    <ul class="page-breadcrumb cus-std-study-page-breadcrumb">
        ...
        <li>
            <span>{{$itemInfo->title}} : Newsletters</span>
        </li>
    </ul>
@stop
                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">
                            Data View : {{$itemInfo->title}} Section Newsletters List
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn sbold green"
                                   href="{{url('/core/pages/news/create', array($pageId, $secId, $itemInfo->id))}}">
                    ...
                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1">
                        ...
                        @foreach($newses as $news)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{{url('/core/pages/news/details', [$pageId, $secId, $itemInfo->id, $news->id])}}"
