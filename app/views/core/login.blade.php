...
<head>
    <meta charset="utf-8" />
    <title>Login | Web Controller</title>
...
<!-- BEGIN LOGO -->
<div class="logo" style="margin-top: 25px; background-color: #F4F4F4;">
    <img src="{{asset($configs[5]->value)}}" alt="logo" class="" />
</div>
<!-- END LOGO -->
